...
public class AbilityTrainingWeyServiceImpl extends AHseService  {
	...
	public ResponseResult checkOS(List<HseRequest> hrList) throws Exception {
		try {
			...
			//设计平衡积分卡
			BalanceVariableDO balanceVariableDO = osMapper.getVariableInfo(VariableConstant.YGNLWEY, JSON.toJSONString(hseRequest.getAnswer()), scoreDO.getStrategicChoice(), scoreDO.getClassId());
