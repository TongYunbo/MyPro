...
public class ModeChoiceServiceImpl extends AHseService  {
	...
	public ResponseResult checkOS(List<HseRequest> hrList) throws Exception {
		try {
			...
			//进行影响处理
			((AHseService) AopContext.currentProxy()).handleFinanceImpact(osMapper, scoreDO, hseRequest, null);
			//添加延迟任务
