...
/**
 * <p>Description: 研发费用投入3</p>
 * @author WTL
 * @date 2019年5月22日
 */
@Service("rDEIThreeService")
@SuppressWarnings("rawtypes")
public class RDEIThreeServiceImpl extends ARDEIService {
	...
	public ResponseResult checkOS(List<HseRequest> hrList) throws Exception {
		try {
			...
			((RDEIThreeServiceImpl) AopContext.currentProxy()).handleRDEI(osMapper, hse, false, vList, itidService, questionService);
