...
public class BalanceScoreCardH6ServiceImpl extends BalanceScoreService {
	...
	public ResponseResult checkOS(List<HseRequest> hrList) throws Exception {
		...
		try {
			...
			((BalanceScoreService) AopContext.currentProxy()).BalanceAdd(
					bsMapper, hrList, NormalConstant.H6_YEAR, sc, ppdMap, questionIds.substring(0, questionIds.length() - 1));
