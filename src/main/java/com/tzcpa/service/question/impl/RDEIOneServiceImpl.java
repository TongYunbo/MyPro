...
/**
 * <p>Description: 研发费用投入1</p>
 * @author WTL
 * @date 2019年5月17日
 */
@Service("rDEIOneService")
@SuppressWarnings("rawtypes")
public class RDEIOneServiceImpl extends ARDEIService {
	...
	public ResponseResult checkOS(List<HseRequest> hrList) throws Exception {
		try {
			...
			((RDEIOneServiceImpl) AopContext.currentProxy()).handleRDEI(osMapper, hse, true, vList, itidService, questionService);
